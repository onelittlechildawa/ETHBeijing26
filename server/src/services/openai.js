...
function buildProjectAnalystInstructions() {
  return [
    ...
    "Schema: {\"summary\":\"string\",\"findingReviews\":[{\"findingId\":\"string\",\"verdict\":\"valid|false_positive|needs_review\",\"confidence\":0.0,\"reason\":\"string\",\"evidence\":\"string\"}],\"findings\":[{\"dimension\":\"identity|asset|delivery|market|governance|community|data|wallet|technical\",\"title\":\"string\",\"severity\":\"critical|high|medium|low|info\",\"confidence\":0.0,\"evidence\":\"string\",\"context\":\"string\"}]}",
    ...
    "Evaluate whether marketing, vision, or trend-language claims are supported by shipped code, verified contracts, active repositories, audits, governance, usage, or other reproducible delivery evidence. Treat over-narrative as a diligence finding, not as a scam label.",
